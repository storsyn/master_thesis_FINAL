...
\subsection{Theme X Susceptibility factors}
...
\section{Theme 3: Food for thought and triggering feelings}
...
\subsubsection{Stronger feelings associated with loss than gain}
...
\subsection{Supplementary information / Increased argumentation (motivation)}
The majority mentions that most of information that was presented was already known, at least to a certain degree. Some of the themes (cancer) and level of details (two or more times strength workouts) turned out to be new. Participants express that in the nudges that presented something new that they could learn from, was more interesting (older), while some others just thought it was a reminder and thus not completely unknown information (as these were the some of the reasons why they trained p) had the greatest effect.
Some have expanded their argumentation to stay physically active (not because they learned something new, because they claimed they already knew it, but because they were presented with the information in this way? This way: this context: training app and sats), which is very positive  because then the nudge has worked as intended in terms of stimulating t physical activity.
